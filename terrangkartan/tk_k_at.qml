...
<qgis simplifyAlgorithm="0" readOnly="0" simplifyDrawingHints="0" version="3.16.4-Hannover" simplifyMaxScale="1" styleCategories="AllStyleCategories" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="1" minScale="50050" maxScale="0" simplifyLocal="1" labelsEnabled="1">
  ...
  <labeling type="rule-based">
    <rules key="{55010de1-31c2-4383-8d3f-94afa47fd772}">
      <rule scalemaxdenom="100050" description="Kommunenklav, storleksklass 1" key="{be6d8463-7bd3-44e6-b80e-ec0947468baf}" filter="&quot;KKOD&quot;=35">
        <settings calloutType="simple">
          <text-style fontStrikeout="0" isExpression="0" textOrientation="horizontal" fontItalic="1" fontSizeUnit="MapUnit" fontLetterSpacing="0" fontUnderline="0" fieldName="TEXT" allowHtml="0" textOpacity="1" namedStyle="Kursiv" textColor="0,0,0,255" fontWeight="50" fontKerning="1" capitalization="0" fontWordSpacing="0" fontFamily="GSDText" fontSize="106" blendMode="0" previewBkgrdColor="255,255,255,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" multilineHeight="1" useSubstitutions="0">
      ...
      <rule scalemaxdenom="100000" scalemindenom="2500" key="{58f330bd-d1f8-4b83-bfcd-5f9a5867a204}" filter="ELSE">
        <settings calloutType="simple">
          ...
          <text-format wrapChar="" rightDirectionSymbol=">" decimals="3" formatNumbers="0" addDirectionSymbol="0" placeDirectionSymbol="0" useMaxLineLengthForAutoWrap="1" multilineAlign="3" leftDirectionSymbol="&lt;" plussign="0" autoWrapLength="0" reverseDirectionSymbol="0"/>
          <placement placementFlags="10" centroidWhole="0" overrunDistanceUnit="MM" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorEnabled="0" distMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" lineAnchorPercent="0.5" preserveRotation="1" repeatDistanceUnits="MM" yOffset="0" geometryGenerator="" placement="0" centroidInside="0" priority="5" layerType="PointGeometry" distUnits="Point" quadOffset="4" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" dist="0" lineAnchorType="0" offsetUnits="MM" polygonPlacementFlags="2" fitInPolygonOnly="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" xOffset="0" offsetType="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" rotationAngle="0" maxCurvedCharAngleOut="-25" repeatDistance="0" overrunDistance="0" geometryGeneratorType="PointGeometry"/>
          <rendering obstacleType="0" labelPerPart="0" obstacleFactor="1" scaleVisibility="0" minFeatureSize="0" drawLabels="1" zIndex="0" upsidedownLabels="0" fontMinPixelSize="3" displayAll="1" mergeLines="0" fontMaxPixelSize="10000" scaleMax="0" obstacle="0" scaleMin="0" maxNumLabels="2000" limitNumLabels="0" fontLimitPixelSize="0"/>
          <dd_properties>
            <Option type="Map">
              <Option type="QString" value="" name="name"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="TKURV">
      <editWidget type="Range">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="TKURV" index="7" name=""/>
  </aliases>
  <defaults>
    ...
    <default field="TKURV" applyOnUpdate="0" expression=""/>
  </defaults>
  <constraints>
    ...
    <constraint notnull_strength="0" exp_strength="0" field="TKURV" constraints="0" unique_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint field="TKURV" desc="" exp=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
    <defaultAction key="Canvas" value="{00000000-0000-0000-0000-000000000000}"/>
  </attributeactions>
  <attributetableconfig sortExpression="&quot;TEXT&quot;" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      <column width="-1" hidden="0" type="field" name="KKOD"/>
      <column width="-1" hidden="0" type="field" name="KATEGORI"/>
      <column width="191" hidden="0" type="field" name="TEXT"/>
      ...
      <column width="-1" hidden="0" type="field" name="TKURV"/>
