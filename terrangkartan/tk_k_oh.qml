...
<qgis minScale="50050" simplifyDrawingTol="1" simplifyLocal="1" version="3.22.6-Białowieża" maxScale="0" labelsEnabled="0" simplifyMaxScale="1" readOnly="0" simplifyAlgorithm="0" styleCategories="LayerConfiguration|Symbology|Symbology3D|Labeling|Fields|Actions|MapTips|Diagrams|AttributeTable|Rendering|CustomProperties|GeometryOptions|Relations|Temporal|Legend" hasScaleBasedVisibilityFlag="1" symbologyReferenceScale="-1" simplifyDrawingHints="1">
  ...
  <renderer-v2 referencescale="-1" enableorderby="0" symbollevels="0" type="categorizedSymbol" attr="KKOD" forceraster="0">
    <categories>
      <category label="Höjdjurva, normal 5 m" symbol="0" value="568" render="true"/>
      <category label="Höjdkurva, stöd för varje 25 m intervall" symbol="1" value="571" render="true"/>
      <category label="Sänka/gropkurva, normal" symbol="2" value="575" render="true"/>
      <category label="Sänka/gropkurva, stöd för varje 25 m intervall" symbol="3" value="576" render="true"/>
      <category label="Skärning" symbol="4" value="598" render="true"/>
      <category label="" symbol="5" value="" render="true"/>
    </categories>
    <symbols>
      <symbol name="0" type="line" force_rhr="0" alpha="1" clip_to_extent="1">
        ...
        <layer locked="0" enabled="1" class="SimpleLine" pass="0">
          <Option type="Map">
            ...
            <Option name="line_color" type="QString" value="185,73,0,255"/>
          ...
          <prop v="185,73,0,255" k="line_color"/>
      ...
      <symbol name="4" type="line" force_rhr="0" alpha="1" clip_to_extent="1">
        ...
        <layer locked="0" enabled="1" class="MarkerLine" pass="0">
          <Option type="Map">
            <Option name="average_angle_length" type="QString" value="11"/>
            ...
            <Option name="interval" type="QString" value="22"/>
            ...
            <Option name="offset" type="QString" value="0"/>
            <Option name="offset_along_line" type="QString" value="11"/>
          ...
          <symbol name="@4@1" type="marker" force_rhr="0" alpha="1" clip_to_extent="1">
            ...
            <layer locked="0" enabled="1" class="SimpleMarker" pass="0">
              <Option type="Map">
                ...
                <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
                <Option name="offset_unit" type="QString" value="MapUnit"/>
                <Option name="outline_color" type="QString" value="185,73,0,255"/>
                ...
                <Option name="size" type="QString" value="26"/>
              ...
              <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
              <prop v="MapUnit" k="offset_unit"/>
              <prop v="185,73,0,255" k="outline_color"/>
