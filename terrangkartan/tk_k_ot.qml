...
<qgis simplifyLocal="1" labelsEnabled="1" readOnly="0" version="3.16.4-Hannover" minScale="50050" simplifyMaxScale="1" simplifyAlgorithm="0" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="0" styleCategories="AllStyleCategories" maxScale="0">
  <flags>
  ...
  <labeling type="rule-based">
    <rules key="{d3c5791e-d50b-4e5e-a43d-1a36cba493f4}">
      <rule scalemaxdenom="50050" key="{0ba4d119-9835-4fce-95fb-7cb7c8b5a610}" description="Djupkurvsiffra" active="0" filter="&quot;KKOD&quot;=98">
        <settings calloutType="simple">
          <text-style fontStrikeout="0" fontWordSpacing="0" fontSizeUnit="MapUnit" blendMode="0" capitalization="0" textColor="0,165,255,255" fontKerning="1" fontUnderline="0" multilineHeight="1" fontItalic="1" allowHtml="0" namedStyle="Kursiv" fontSize="88" fontFamily="GSDText" isExpression="0" textOpacity="1" useSubstitutions="0" fontWeight="50" previewBkgrdColor="255,255,255,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontLetterSpacing="0" textOrientation="horizontal" fieldName="TEXT">
            <text-buffer bufferDraw="0" bufferOpacity="1" bufferNoFill="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="1" bufferSizeUnits="MM" bufferJoinStyle="128" bufferBlendMode="0" bufferColor="255,255,255,255"/>
          ...
          <text-format autoWrapLength="0" formatNumbers="0" decimals="3" reverseDirectionSymbol="0" multilineAlign="3" placeDirectionSymbol="0" leftDirectionSymbol="&lt;" rightDirectionSymbol=">" addDirectionSymbol="0" wrapChar="" useMaxLineLengthForAutoWrap="1" plussign="0"/>
          <placement centroidWhole="0" repeatDistance="0" xOffset="0" placement="1" preserveRotation="1" overrunDistanceUnit="MM" overrunDistance="0" layerType="PointGeometry" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" yOffset="0" polygonPlacementFlags="2" maxCurvedCharAngleOut="-25" geometryGenerator="" geometryGeneratorEnabled="0" priority="5" offsetType="0" rotationAngle="0" distMapUnitScale="3x:0,0,0,0,0,0" quadOffset="4" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MapUnit" dist="0" fitInPolygonOnly="0" lineAnchorPercent="0.5" geometryGeneratorType="PointGeometry" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" placementFlags="10" lineAnchorType="0" distUnits="MM" repeatDistanceUnits="MM" maxCurvedCharAngleIn="25"/>
          <rendering upsidedownLabels="0" fontLimitPixelSize="0" fontMinPixelSize="3" mergeLines="0" labelPerPart="0" scaleMin="0" maxNumLabels="2000" zIndex="0" limitNumLabels="0" fontMaxPixelSize="10000" minFeatureSize="0" drawLabels="1" scaleVisibility="0" displayAll="1" obstacleFactor="1" obstacle="0" scaleMax="0" obstacleType="0"/>
          <dd_properties>
            <Option type="Map">
              <Option value="" type="QString" name="name"/>
      ...
      <rule scalemaxdenom="50050" key="{65422a57-1e7c-413b-b98e-4c2af2e566e3}" description="Höjdkurvsiffra" filter="&quot;KKOD&quot;=99">
        <settings calloutType="simple">
          <text-style fontStrikeout="0" fontWordSpacing="0" fontSizeUnit="MapUnit" blendMode="0" capitalization="0" textColor="185,73,0,255" fontKerning="1" fontUnderline="0" multilineHeight="1" fontItalic="1" allowHtml="0" namedStyle="Kursiv" fontSize="88" fontFamily="GSDText" isExpression="0" textOpacity="1" useSubstitutions="0" fontWeight="50" previewBkgrdColor="255,255,255,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontLetterSpacing="0" textOrientation="horizontal" fieldName="TEXT">
            <text-buffer bufferDraw="0" bufferOpacity="1" bufferNoFill="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="1" bufferSizeUnits="MM" bufferJoinStyle="128" bufferBlendMode="0" bufferColor="255,255,255,255"/>
            <text-mask maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskEnabled="0" maskOpacity="1" maskSizeUnits="MM" maskedSymbolLayers="" maskSize="0" maskJoinStyle="128" maskType="0"/>
            <background shapeRotationType="0" shapeBorderWidth="0" shapeSVGFile="" shapeSizeType="0" shapeBlendMode="0" shapeOffsetY="0" shapeSizeUnit="MM" shapeBorderColor="128,128,128,255" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeFillColor="255,255,255,255" shapeSizeX="0" shapeOffsetUnit="MM" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeSizeY="0" shapeJoinStyle="64" shapeRadiiUnit="MM" shapeBorderWidthUnit="MM" shapeRotation="0" shapeRadiiX="0" shapeType="0" shapeDraw="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetX="0" shapeRadiiY="0" shapeOpacity="1" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0">
              <symbol clip_to_extent="1" type="marker" alpha="1" name="markerSymbol" force_rhr="0">
          ...
          <text-format autoWrapLength="0" formatNumbers="0" decimals="3" reverseDirectionSymbol="0" multilineAlign="3" placeDirectionSymbol="0" leftDirectionSymbol="&lt;" rightDirectionSymbol=">" addDirectionSymbol="0" wrapChar="" useMaxLineLengthForAutoWrap="1" plussign="0"/>
          <placement centroidWhole="0" repeatDistance="0" xOffset="0" placement="1" preserveRotation="1" overrunDistanceUnit="MM" overrunDistance="0" layerType="PointGeometry" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" yOffset="0" polygonPlacementFlags="2" maxCurvedCharAngleOut="-25" geometryGenerator="" geometryGeneratorEnabled="0" priority="5" offsetType="0" rotationAngle="0" distMapUnitScale="3x:0,0,0,0,0,0" quadOffset="4" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MapUnit" dist="0" fitInPolygonOnly="0" lineAnchorPercent="0.5" geometryGeneratorType="PointGeometry" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" placementFlags="10" lineAnchorType="0" distUnits="MM" repeatDistanceUnits="MM" maxCurvedCharAngleIn="25"/>
          <rendering upsidedownLabels="1" fontLimitPixelSize="0" fontMinPixelSize="3" mergeLines="0" labelPerPart="0" scaleMin="0" maxNumLabels="2000" zIndex="0" limitNumLabels="0" fontMaxPixelSize="10000" minFeatureSize="0" drawLabels="1" scaleVisibility="0" displayAll="0" obstacleFactor="1" obstacle="0" scaleMax="0" obstacleType="0"/>
          <dd_properties>
            <Option type="Map">
              <Option value="" type="QString" name="name"/>
              <Option type="Map" name="properties">
      ...
      <rule scalemaxdenom="50000" key="{54d18483-a65b-4afa-9c00-52cf9a4a9033}" scalemindenom="1000" filter="ELSE">
        <settings calloutType="simple">
          <text-style fontStrikeout="0" fontWordSpacing="0" fontSizeUnit="Point" blendMode="0" capitalization="0" textColor="255,0,0,255" fontKerning="1" fontUnderline="0" multilineHeight="1" fontItalic="0" allowHtml="0" namedStyle="Normal" fontSize="10" fontFamily="Arial" isExpression="0" textOpacity="1" useSubstitutions="0" fontWeight="50" previewBkgrdColor="255,255,255,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontLetterSpacing="0" textOrientation="horizontal" fieldName="TEXT">
            <text-buffer bufferDraw="0" bufferOpacity="1" bufferNoFill="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSize="1" bufferSizeUnits="MM" bufferJoinStyle="128" bufferBlendMode="0" bufferColor="255,255,255,255"/>
            <text-mask maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskEnabled="0" maskOpacity="1" maskSizeUnits="MM" maskedSymbolLayers="" maskSize="0" maskJoinStyle="128" maskType="0"/>
            <background shapeRotationType="0" shapeBorderWidth="0" shapeSVGFile="" shapeSizeType="0" shapeBlendMode="0" shapeOffsetY="0" shapeSizeUnit="MM" shapeBorderColor="128,128,128,255" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeFillColor="255,255,255,255" shapeSizeX="0" shapeOffsetUnit="MM" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeSizeY="0" shapeJoinStyle="64" shapeRadiiUnit="MM" shapeBorderWidthUnit="MM" shapeRotation="0" shapeRadiiX="0" shapeType="0" shapeDraw="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetX="0" shapeRadiiY="0" shapeOpacity="1" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0">
              <symbol clip_to_extent="1" type="marker" alpha="1" name="markerSymbol" force_rhr="0">
          ...
          <text-format autoWrapLength="0" formatNumbers="0" decimals="3" reverseDirectionSymbol="0" multilineAlign="3" placeDirectionSymbol="0" leftDirectionSymbol="&lt;" rightDirectionSymbol=">" addDirectionSymbol="0" wrapChar="" useMaxLineLengthForAutoWrap="1" plussign="0"/>
          <placement centroidWhole="0" repeatDistance="0" xOffset="0" placement="0" preserveRotation="1" overrunDistanceUnit="MM" overrunDistance="0" layerType="PointGeometry" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" yOffset="0" polygonPlacementFlags="2" maxCurvedCharAngleOut="-25" geometryGenerator="" geometryGeneratorEnabled="0" priority="5" offsetType="0" rotationAngle="0" distMapUnitScale="3x:0,0,0,0,0,0" quadOffset="4" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MM" dist="0" fitInPolygonOnly="0" lineAnchorPercent="0.5" geometryGeneratorType="PointGeometry" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" placementFlags="10" lineAnchorType="0" distUnits="MapUnit" repeatDistanceUnits="MM" maxCurvedCharAngleIn="25"/>
          <rendering upsidedownLabels="0" fontLimitPixelSize="0" fontMinPixelSize="3" mergeLines="0" labelPerPart="0" scaleMin="0" maxNumLabels="2000" zIndex="0" limitNumLabels="0" fontMaxPixelSize="10000" minFeatureSize="0" drawLabels="1" scaleVisibility="0" displayAll="1" obstacleFactor="1" obstacle="0" scaleMax="0" obstacleType="0"/>
          <dd_properties>
            <Option type="Map">
              <Option value="" type="QString" name="name"/>
