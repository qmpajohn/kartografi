...
<qgis simplifyAlgorithm="0" readOnly="0" simplifyDrawingHints="1" version="3.16.4-Hannover" simplifyMaxScale="1" styleCategories="AllStyleCategories" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="1" minScale="100050" maxScale="0" simplifyLocal="1" labelsEnabled="0">
  <flags>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" attr="KKOD" enableorderby="0" type="categorizedSymbol">
    <categories>
      <category label="Sankmark, svårframkomlig" render="true" value="31" symbol="0"/>
      <category label="Sankmark, normal" render="true" value="32" symbol="1"/>
      <category label="Berg i dagen" render="true" value="33" symbol="2"/>
      <category label="Sankmark, torvtäkt" render="true" value="35" symbol="3"/>
      <category label="Sankmark, blekvät" render="true" value="37" symbol="4"/>
    ...
    <symbols>
      <symbol alpha="1" force_rhr="0" type="fill" clip_to_extent="1" name="0">
        <layer enabled="1" locked="0" pass="0" class="LinePatternFill">
          <prop v="0" k="angle"/>
          <prop v="191,81,221,255" k="color"/>
          <prop v="26" k="distance"/>
        ...
        <layer enabled="1" locked="0" pass="0" class="LinePatternFill">
          ...
          <symbol alpha="1" force_rhr="0" type="line" clip_to_extent="1" name="@1@0">
            <layer enabled="1" locked="0" pass="0" class="SimpleLine">
              ...
              <prop v="0" k="draw_inside_polygon"/>
              <prop v="round" k="joinstyle"/>
              <prop v="237,92,0,255" k="line_color"/>
              <prop v="solid" k="line_style"/>
              <prop v="5" k="line_width"/>
              <prop v="MapUnit" k="line_width_unit"/>
              <prop v="0" k="offset"/>
      ...
      <symbol alpha="1" force_rhr="0" type="fill" clip_to_extent="1" name="4">
        <layer enabled="1" locked="0" pass="0" class="PointPatternFill">
          ...
          <symbol alpha="1" force_rhr="0" type="marker" clip_to_extent="1" name="@4@0">
            <layer enabled="1" locked="0" pass="0" class="EllipseMarker">
              <prop v="0" k="angle"/>
  ...
  <DiagramLayerSettings linePlacementFlags="18" placement="1" dist="0" obstacle="0" priority="0" showAll="1" zIndex="0">
    <properties>
      <Option type="Map">
        <Option type="QString" value="" name="name"/>
        <Option name="properties"/>
  ...
  <attributetableconfig sortExpression="&quot;KKOD&quot;" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column width="194" hidden="0" type="field" name="KATEGORI"/>
